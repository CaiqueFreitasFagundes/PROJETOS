# Ao se tratar de um projeto de Dash, é necessário que o arquivo principal contenha as informações de design e layout, enquanto o arquivo de modelo contenha as informações de dados e gráficos.
